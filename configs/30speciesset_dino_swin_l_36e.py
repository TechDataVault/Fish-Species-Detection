...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/workspace/30spec_fish_coco_json/val_coco.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='/workspace/30spec_fish_coco',
...
train_cfg = dict(max_epochs=72, type='EpochBasedTrainLoop', val_interval=2)
train_dataloader = dict(
    batch_sampler=dict(type='AspectRatioBatchSampler'),
    batch_size=2,
    dataset=dict(
        ann_file='/workspace/30spec_fish_coco_json/train_coco.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='/workspace/30spec_fish_coco',
...
work_dir = './work_dirs/30speciesset_dino_swin_l_36e'
